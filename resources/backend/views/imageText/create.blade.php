            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Texto Imagem</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Dashboard</a></li>
                                <li class="breadcrumb-item">Texto Imagem</li>
                                <li class="breadcrumb-item active">Criar Texto Imagem</li>
                            </ol>
                        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="card-title">Aqui pode criar o seu Texto Imagem</h4>
                            <br>
                            <form method="post" action="{{ route('imageText.store') }}" enctype="multipart/form-data">
                                @csrf
                                {{--Page--}}
                                <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="form-control @error('text') is-invalid @enderror" id="elm1" name="text">{{ old('text') }}</textarea>
                                        @error('subtitle')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
