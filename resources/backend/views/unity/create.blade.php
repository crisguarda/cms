                    ...
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">Criar Unidades</li>
                            </ol>
                        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="card-title">Aqui pode criar a sua Unidade</h4>
                            <br>
                            <form method="post" action="{{ route('unity.store') }}" enctype="multipart/form-data">
                                @csrf
                                {{--Unity--}}
                                <div class="row mb-3">
                                    <label for="title" class="col-sm-2 col-form-label">Unidade</label>
                                    <div class="col-sm-10">
                                        <input class="form-control @error('unity') is-invalid @enderror" type="text" placeholder="Unidade" id="unity" name="unity" value="{{ old('unity') }}">
                                        @error('unity')
