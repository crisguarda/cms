            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Produtos da Categoria</h4>

                        <div class="page-title-right">
                            <a href="{{ route('product.create', ['category' => $productCategory]) }}" type="button" class="btn btn-light waves-effect">Criar Produtos da Categoria</a>
                        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="card-title">Produtos da Categoria</h4>
                            <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                ...
                                @empty
                                    <tr>
                                        <td class="text-center" colspan="4">Ainda nao foram cridos Produtos</td>
                                    </tr>
                                @endforelse
                                </tbody>
                            </table>
