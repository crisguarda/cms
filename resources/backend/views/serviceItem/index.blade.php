                ...
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            <a href="{{ route('image.create',['gallery_id' => $gallery_id]) }}" type="button" class="btn btn-light waves-effect">Criar Imagens da Galeria</a>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                ...
                                @empty
                                    <tr>
                                        <td class="text-center" colspan="4">Ainda nao foram criadoas Imagens da Galeria</td>
                                    </tr>
                                @endforelse
                                </tbody>
                            </table>
