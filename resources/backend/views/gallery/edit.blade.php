                    ...
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item">Galleria de Imagens</li>
                                <li class="breadcrumb-item active">Editar Galleria de Imagens</li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="card-title">Aqui pode editar a sua Galleria de Imagens</h4>
                            <br>
                            <form method="post" action="{{ route('gallery.update', $gallery->id) }}" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-select @error('page_id') is-invalid @enderror" aria-label="Default select example" name="page_id">
                                            ...
                                            @php
                                                $selected = old('page_id') ?? $gallery->page_id;
                                            @endphp
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control @error('title') is-invalid @enderror" type="text" placeholder="Titulo" id="title" name="title" value="{{ old('title') ?? $gallery->title }}">
                                        @error('title')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control @error('subtitle') is-invalid @enderror" type="text" placeholder="Subitulo" id="subtitle" name="subtitle" value="{{ old('subtitle') ?? $gallery->subtitle }}">
                                        @error('subtitle')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control @error('order') is-invalid @enderror" type="number" placeholder="Ordem" id="order" name="order" value="{{ old('order') ?? $gallery->order }}">
                                        @error('order')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-3 form-switch">
                                    ...
                                    <div class="col-sm-10">
                                        @php
                                            $value = old('active') ?? $gallery->active;
                                        @endphp
