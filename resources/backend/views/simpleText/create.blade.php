                    ...
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">Criar Texto Simples</li>
                            </ol>
                        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="card-title">Aqui pode criar o seu Texto Simples</h4>
                            <br>
                            <form method="post" action="{{ route('simpleText.store') }}" enctype="multipart/form-data">
                                @csrf
                                {{--Page--}}
                                <div class="row mb-3">
